...
#image_name1,image_name2要进行匹配的人脸的路径名称
#函数返回值为欧氏距离，小于0.9为同一张脸

def getDiatance(image_name1,image_name2):
    image_size = 200  # don't need equal to real image size, but this value should not small than this
    modeldir = './20170512-110547.pb'  # change to your model dir
    #image_name1 = '3.jpg'  # change to your image name
    #image_name2 = '33.jpg'  # change to your image name
